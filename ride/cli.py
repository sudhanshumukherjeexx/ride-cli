...
class RideInteractive:
    ...
    def _display_minimalist_header(self):
        ...
        if terminal_width >= 80:
            # Use a smaller, more compact font
            f = Figlet(font='banner3-D', width=terminal_width)  # Changed from 'doh' to 'standard'
            logo_text = f.renderText('RIDE CLI')
            
            # Print each line centered
            for line in logo_text.rstrip().split('\n'):
                print(colored(line.center(terminal_width), 'green'))
        else:
            # Fallback to even smaller font for narrow terminals
    ...
    def display_formatted_description(self):
        ...
        # Description text
        description = """RIDE: Rapid Insights Data Engine

            RIDE is a free open-source toolkit that lets you perform data analysis without writing a single line of code and minimal intervention."""
    ...
    def load_data(self):
        ...
        if choice == '0':
            ...
            file_path = input("\nEnter the path to your dataset file (CSV, Excel, Parquet): ")
    ...
    def automl(self):
        ...
        while True:
            ...
            try:
                ...
                try:
                    from ride.automl_processor import AutoMLProcessor  # Adjust import path as needed
    ...
    def run(self):
        ...
        while True:
            ...
            print("\n'exit': Exit RIDE CLI")  # Changed from Exit Prepup
            ...
            if choice == '1':
                ...
                print(colored("\nThank you for using RIDE CLI!", 'green')) 
                print(colored("Exiting...", 'light_blue'))
                sys.exit(0)
            else: 
                print(colored("\nInvalid Choice. Thank you for using RIDE CLI!", 'green')) 
                print(colored("Exiting...", 'light_blue'))
                sys.exit(0)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="""
        ...
        RIDE is a free open-source toolkit that lets you perform data analysis without writing a single line of code.
        """)
    ...
    app = RideInteractive()  # Changed from PrepupInteractive
